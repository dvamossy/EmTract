...
def cmd_inference(args=None):
    ...
    parser.add_argument('-t', '--model_type', type=str, default='stocktwits', choices=['twitter', 'stocktwits'],
    ...
    parser.add_argument('-i', '--input_file', type=str, required='--interactive' not in sys.argv,
                        help='Input csv file were the first column will be evaluated')
    parser.add_argument('-o', '--output_file', type=str, required='--interactive' not in sys.argv,
