...
segmented_df = pd.read_csv(BASE_DIR + 'segmented_df.csv.gz').dropna()
autocorrected_df = pd.read_csv(BASE_DIR + 'auto_corrected_df.csv.gz').dropna()
...
company_titles = set(symbols_df.title)
non_ambiguous_company_titles = set(symbols_df[symbols_df.ambiguous_title == False].title)
